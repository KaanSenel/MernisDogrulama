...
public class KCOKPSPublicSoap
{
    ...
    public KCOKPSPublicSoap(){}

    public KCOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KCOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KCOExtendedSoapSerializationEnvelope envelope= new KCOExtendedSoapSerializationEnvelope(KCOExtendedSoapSerializationEnvelope.VER11);
