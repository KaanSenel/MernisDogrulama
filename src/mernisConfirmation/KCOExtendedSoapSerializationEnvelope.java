...
public class KCOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KCODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new KCOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KCODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KCODateTimeConverter dateTimeConverter = new KCOStandardDateTimeConverter();

    public KCOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KCOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KCOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KCOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KCOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KCOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
